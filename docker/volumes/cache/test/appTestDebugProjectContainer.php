...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api.tool_handler' => 'getApi_ToolHandlerService',
            'api.tool_normalizer' => 'getApi_ToolNormalizerService',
    ...
    /**
     * Gets the public 'api.tool_handler' shared service.
     *
     * @return \ApiBundle\Service\Request\ToolHandler
     */
    protected function getApi_ToolHandlerService()
    {
        return $this->services['api.tool_handler'] = new \ApiBundle\Service\Request\ToolHandler($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'api.tool_normalizer' shared service.
     *
     * @return \ApiBundle\Service\Normalize\ToolNormalizer
     */
    protected function getApi_ToolNormalizerService()
    {
        return $this->services['api.tool_normalizer'] = new \ApiBundle\Service\Normalize\ToolNormalizer();
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M0tV-HyhVv', 0, 'XJuoN7hhubl+UkN9ioKQnu', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'database', 'port' => NULL, 'dbname' => 'vuttr', 'user' => 'vuttr', 'password' => 'vuttr', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tfCBTmT5WB', 0, 'XJuoN7hhubl+UkN9ioKQnu', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m-eVmzNL5g', 0, 'XJuoN7hhubl+UkN9ioKQnu', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5d02f9f06e1bf7.42145308')), true);
